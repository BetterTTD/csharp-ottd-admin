...
using OpenTTD.Networking.Abstractions.Messages.Outbound;
...
{
    public static IServiceCollection AddAdminClientNetworking(this IServiceCollection services) => services
